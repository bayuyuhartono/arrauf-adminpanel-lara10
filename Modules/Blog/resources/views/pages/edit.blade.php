...
<div class="card card-primary">
  ...
  <form action="{{ url()->current() }}" method="post" autocomplete="off" enctype="multipart/form-data">
      ...
      <div class="col-sm-12">
        ...
        <div class="form-group">
          ...
          <div class="input-group mb-3">
            <input class="form-control" name="code" placeholder="Kode" value="{{ $data->code }}" required>
          </div>
        </div>
        <div class="form-group">
    ...
    <div class="card-footer">
      ...
      <a href="{{ url('blog/pages') }}" onclick="return confirm('Anda yakin mau kembali?')" class="btn btn-success">Kembali</a>
    </div>
  </form>
</div>
